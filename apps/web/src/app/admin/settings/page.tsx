  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          Configure global metadata, storefront branding icons, and general
          contact details.
        </p>
      </div>
        ...
        <div className="settings-form-grid" style={{ gap: "1.5rem" }}>
          <div>
            <FormField
              ...
              hint="Drawn as the main logo header on public pages."
            >
              <input
                type="file"
                ref={logoInputRef}
          ...
          <div>
            <FormField
              ...
              hint="Displayed inside web browser address title tabs."
            >
              <input
                type="file"
                ref={faviconInputRef}
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        ...
        >
          <Save size={14} />
          <span>
            {saved ? "Branding Saved Successfully" : "Save All Configurations"}
          </span>
        </button>
      </div>
