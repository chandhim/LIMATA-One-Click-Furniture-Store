...
export default function AdminChatsPage() {
  ...
  const filteredConversations = conversations.filter((c: Conversation) => {
    ...
    const matchesName =
      c.customer?.name?.toLowerCase().includes(query) ?? false;
    const matchesEmail =
      c.customer?.email?.toLowerCase().includes(query) ?? false;
                  ...
                  <div
                    style={{
                      ...
                      boxShadow: isSelected
                        ? "0 2px 6px rgba(201,169,110,0.15)"
                        : "none",
                      transition: "all 0.2s ease",
                    }}
                  >
      ...
      >
        {selectedConversationId && user?.userId ? (
          ...
          >
            ...
            >
              Select a customer conversation from the list to start messaging in
              real-time.
            </p>
          </div>
        )}
